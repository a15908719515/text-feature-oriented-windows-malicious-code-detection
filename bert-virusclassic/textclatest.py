...
tokenizer = BertTokenizer.from_pretrained('E:\pycharmcode\model\\bert-base-uncased')
...
class BertClassifier(nn.Module):
    def __init__(self, dropout=0.5):
        ...
        self.bert = BertModel.from_pretrained('E:\pycharmcode\model\\bert-base-uncased')
